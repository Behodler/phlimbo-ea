 ...
 */
contract PhlimboV2 is Ownable, Pausable, ReentrancyGuard, IPhlimboV2, IPausable {
    ...
    /**
     * @notice Initializes the PhlimboV2 staking contract
